...
public class VelocityUtils {
    ...
    static {
        ...
        INIT_PROP.setProperty(RuntimeConstants.DEFAULT_RUNTIME_LOG_NAME, "org.apache.velocity.runtime.log.Log4JLogChute");
    ...
    public static String generate(String template, Map<String, Object> map) {
        ...
        if (map != null) {
            ...
            if (Objects.nonNull(version) && !StringUtils.isEmpty(version.toString())) {
                template = template.replaceAll("#set\\(\\$version = \".+\"\\)", "#set(\\$version = \"" + version + "\")");
            }
        }
        try {
            // 生成代码
